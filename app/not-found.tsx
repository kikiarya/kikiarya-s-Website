  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center py-40">
      <Container className="text-center">
        <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-accent font-bold mb-8 block">Error 404</span>
        ...
        <Link href="/" className="px-10 py-4 bg-foreground text-background rounded-full text-xs font-bold uppercase tracking-widest hover:bg-accent transition-all">
          Return Home
        </Link>
      </Container>
    </div>
